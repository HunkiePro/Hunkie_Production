                                ...
                                <tbody>
                                    ...
                                    if ($result && $result->num_rows > 0) {
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            echo '<td>' . (isset($row['senderName']) ? $row['senderName'] : '') . '</td>';
                                            echo '<td>' . (isset($row['senderEmail']) ? $row['senderEmail'] : '') . '</td>';
                                            echo '<td>' . (isset($row['subject']) ? $row['subject'] : '') . '</td>';
                                            echo '<td>' . (isset($row['message']) ? $row['message'] : '') . '</td>';
                                            echo '<td>' . (isset($row['sent_at']) ? $row['sent_at'] : '') . '</td>';
                                            echo '</tr>';
                                            $counter++; // Increment the counter for the next row
                                        }
                                    } else {
                                        echo '<tr><td colspan="5">No Messages for you.</td></tr>';
                                    }
